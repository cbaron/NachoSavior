module.exports = Object.create( {
    ...
    DELETE( resource ) {
        ...
        return this.parseSihgnature( resource, this.parseCookies( resource.request.headers.cookie ) )
    },

    GET( resource ) {
        return this.parseSignature( resource, this.parseCookies( resource.request.headers.cookie ) )
        .then( () =>
            ( Object.keys( resource.user ).length === 0 && ( ![ 'me', 'comic' ].includes( resource.path[0] ) ) )
                ? Promise.reject("401")
                : Promise.resolve()
        )
    },
